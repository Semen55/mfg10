      ...
      try {
        ...
        while (taskNumber <= 100) {
          try {
            ...
            const response = await fetch(`/mfg10/tasks/${taskNumber}.txt`);
            ...
            let hasImage = false;
            try {
              const imgResponse = await fetch(`/mfg10/tasks/pics/${taskNumber}.png`, { method: 'HEAD' });
              if (imgResponse.ok) {
            ...
            tasks.push({
              id: taskNumber,
              text: text.trim(),
              imagePath: hasImage ? `/mfg10/tasks/pics/${taskNumber}.png` : null,
            });
  ...
  return (
    <GameContainer>
      <MapWrapper>
        ...
        >
          <img src="/mfg10/images/undo-icon.png" alt="Отменить" />
        </UndoButton>
        ...
        >
          <img src="/mfg10/images/redo-icon.png" alt="Повторить" />
        </RedoButton>
          ...
          <CaptureModalBackdrop>
            <CaptureModalCard>
              ...
              <CaptureModalSideActions className="left" isNeutral={false}>
                ...
                >
                  <img src="/mfg10/images/defend-wrong-icon.png" alt="Защита неверно" />
                </CaptureButton>
                <CaptureButton
                ...
                >
                  <img src="/mfg10/images/defend-correct-icon.png" alt="Защита верно" />
                </CaptureButton>
              ...
              <CaptureModalSideActions className="right" isNeutral={false}>
                ...
                >
                  <img src="/mfg10/images/attack-wrong-icon.png" alt="Атака неверно" />
                </CaptureButton>
                <CaptureButton
                ...
                >
                  <img src="/mfg10/images/attack-correct-icon.png" alt="Атака верно" />
                </CaptureButton>
              </CaptureModalSideActions>
            </CaptureModalCard>
          </CaptureModalBackdrop>
